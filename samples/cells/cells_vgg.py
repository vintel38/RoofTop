...
def train(model):
    ...
    dataset_train.load_cells(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = CellsDataset()
    dataset_val.load_cells(args.dataset, "val")
    dataset_val.prepare()
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect cellss.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'splash'")
    parser.add_argument('--dataset', required=False,
                        metavar="/path/to/cells/dataset/",
                        help='Directory of the Cells dataset')
